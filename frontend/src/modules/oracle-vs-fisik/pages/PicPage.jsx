...
import { PIC_ROWS } from "../data";

function PicPage() {
  const columns = [
    { key: "no", label: "No.", render: (_, i) => i + 1 },
    { key: "warehouse", label: "Warehouse" },
    { key: "penneng", label: "No. Penneng / Id", render: (r) => <span className="cell-code">{r.penneng}</span> },
    { key: "nama", label: "Nama Personel", render: (r) => <span className="cell-strong">{r.nama}</span> },
